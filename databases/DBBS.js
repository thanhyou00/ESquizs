  ...
  $scope.src = [
    {
      ...
      AnswerId: 103344,
      Answers: [
        { Id: 103343, Text: "Thực hiện thao tác dữ liệu và truy vấn dữ liệu" },
        {
          Id: 103344,
          Text: "Quản lý lưu trữ dữ liệu, thao tác dữ liệu và truy vấn dữ liệu",
        },
        { Id: 103345, Text: "Quản lý lưu trữ dữ liệu, thêm, sửa, xóa dữ liệu" },
        { Id: 103346, Text: "Cho phép lưu trữ dữ liệu và truy vấn dữ liệu" },
      ],
    },
    {
      Id: 24917,
      ...
      AnswerId: 103349,
      Answers: [
        { Id: 103347, Text: "Hỗ trợ các ngôn ngữ giao tiếp" },
        { Id: 103348, Text: "Quản trị các cơ sở dữ liệu" },
        {
          Id: 103349,
          Text: "Cung cấp các truy cập đến tổ chức dữ liệu vật lý",
        },
        { Id: 103350, Text: "Có cơ chế an toàn, bảo mật cao" },
      ],
    },
    {
      Id: 24918,
      ...
      Answers: [
        ...
        { Id: 103352, Text: "Liên hệ dữ liệu có thể thừa kế giữa cha và con" },
        { Id: 103353, Text: "Kiểu quan hệ là 1-N và N-N" },
        {
          Id: 103354,
    ...
    },
    {
      ...
      AnswerId: 103361,
      Answers: [
        { Id: 103359, Text: "Các ký tự, ký số" },
        { Id: 103360, Text: "Hình ảnh, âm thanh" },
        { Id: 103361, Text: "Các phương án đều đúng" },
        { Id: 103362, Text: "Ký hiệu" },
      ],
    },
    {
      Id: 24921,
      ...
      AnswerId: 103366,
      Answers: [
        { Id: 103363, Text: "Dữ liệu dạng âm thanh" },
        { Id: 103364, Text: "Dữ liệu dạng ký hiệu" },
        { Id: 103365, Text: "Dữ liệu dạng ký số" },
        { Id: 103366, Text: "Dữ liệu dạng hình ảnh" },
      ],
    },
    {
      Id: 24922,
    ...
    },
    {
      ...
      AnswerId: 103372,
      Answers: [
        { Id: 103371, Text: "Hệ quản trị cơ sở dữ liệu phân cấp" },
        { Id: 103372, Text: "Hệ quản trị cơ sở dữ liệu quan hệ" },
        { Id: 103373, Text: "Hệ quản trị cơ sở dữ liệu mạng" },
        { Id: 103374, Text: "Hệ quản trị cơ sở dữ liệu hướng đối tượng" },
      ],
    },
    {
      Id: 24924,
    ...
    },
    {
      ...
      AnswerId: 103382,
      Answers: [
        { Id: 103379, Text: "Dữ liệu dạng âm thanh" },
        { Id: 103380, Text: "Dữ liệu dạng hình ảnh" },
        { Id: 103381, Text: "Dữ liệu dạng ký hiệu" },
        { Id: 103382, Text: "Dữ liệu dạng ký tự, ký số" },
      ],
    },
    {
      Id: 24926,
    ...
    },
    {
      ...
      AnswerId: 103400,
      Answers: [
        { Id: 103399, Text: "Quan hệ 0-0, 1-1, n-n" },
        { Id: 103400, Text: "Quan hệ 1-1, 1-n, n-n" },
        { Id: 103401, Text: "Quan hệ 0-1, 1-1, n-n" },
        { Id: 103402, Text: "Quan hệ 1-n, n-n, n-1" },
      ],
    },
    {
      Id: 24931,
      ...
      AnswerId: 103404,
      Answers: [
        { Id: 103403, Text: "Ràng buộc quy tắc" },
        { Id: 103404, Text: "Ràng buộc toàn vẹn" },
        { Id: 103405, Text: "Ràng buộc sự kiện" },
        { Id: 103406, Text: "Ràng buộc chính xác" },
      ],
    },
    {
      Id: 24932,
      ...
      AnswerId: 103409,
      Answers: [
        { Id: 103407, Text: "Thủ tục công ty" },
        { Id: 103408, Text: "Quy trình công việc" },
        { Id: 103409, Text: "Quy tắc nghiệp vụ" },
        { Id: 103410, Text: "Quy định công việc" },
      ],
    },
    {
      Id: 24933,
      ...
      AnswerId: 103412,
      Answers: [
        { Id: 103411, Text: "Company Name" },
        { Id: 103412, Text: "Customer" },
        { Id: 103413, Text: "Customer ID" },
        { Id: 103414, Text: "Address" },
      ],
    },
    {
      Id: 24934,
      ...
      AnswerId: 103418,
      Answers: [
        { Id: 103415, Text: "Thuộc tính chính" },
        { Id: 103416, Text: "Khóa ngoại" },
        { Id: 103417, Text: "Thuộc tính xác định" },
        { Id: 103418, Text: "Khóa chính" },
      ],
    },
    {
      Id: 24935,
    ...
    },
    {
      ...
      AnswerId: 103424,
      Answers: [
        { Id: 103423, Text: "SELECT ALL FROM EMPLOYEES" },
        { Id: 103424, Text: "SELECT * FROM EMPLOYEES" },
        { Id: 103425, Text: "SELECT * WHERE EMPLOYEES" },
        { Id: 103426, Text: "SELECT ALL WHERE EMPLOYEES" },
      ],
    },
    {
      Id: 24937,
    ...
    },
    {
      ...
      AnswerId: 103440,
      Answers: [
        { Id: 103439, Text: "SELECT * FROM EMPLOYEES ORDER First_Name DESC" },
        {
          Id: 103440,
    ...
    },
    {
      ...
      AnswerId: 103449,
      Answers: [
        { Id: 103447, Text: "SORT BY" },
        { Id: 103448, Text: "SORT" },
        { Id: 103449, Text: "ORDER BY" },
        { Id: 103450, Text: "ORDER" },
      ],
    },
    {
      Id: 24943,
    ...
    },
    {
      ...
      AnswerId: 103458,
      Answers: [
        { Id: 103455, Text: "Insert, Update, Delete" },
        { Id: 103456, Text: "Grant, Revoke" },
        { Id: 103457, Text: "Select" },
        { Id: 103458, Text: "Create, Drop, Alter" },
      ],
    },
    {
      Id: 24945,
    ...
    },
    {
      ...
      AnswerId: 103474,
      Answers: [
        { Id: 103471, Text: "DELETE * FROM Employees WHERE Employee_ID = 213" },
        { Id: 103472, Text: "DELETE Employees WHERE Employee_ID = 213" },
        { Id: 103473, Text: "DELETE Employees.Employee_ID = 213" },
        { Id: 103474, Text: "DELETE FROM Employees WHERE Employee_ID = 213" },
      ],
    },
    {
      Id: 24949,
    ...
    },
    {
      ...
      AnswerId: 103481,
      Answers: [
        { Id: 103479, Text: "SELECT SMALLEST(Salary) FROM Employees" },
        { Id: 103480, Text: "SELECT MIN Salary FROM Employees" },
        { Id: 103481, Text: "SELECT MIN(Salary) FROM Employees" },
        { Id: 103482, Text: "SELECT SMALLEST Salary FROM Employees" },
      ],
    },
    {
      Id: 24951,
      ...
      AnswerId: 103486,
      Answers: [
        { Id: 103483, Text: "REVOKE UPDATE ON HR" },
        { Id: 103484, Text: "REVOKE UPDATE TO HR" },
        { Id: 103485, Text: "REVOKE UPDATE INTO HR" },
        { Id: 103486, Text: "REVOKE UPDATE FROM HR" },
      ],
    },
    {
      Id: 24952,
      ...
      AnswerId: 103488,
      Answers: [
        { Id: 103487, Text: "TRUNCATE TABLE Khach_Hang IGNORE CONSTRAINTS;" },
        { Id: 103488, Text: "DROP TABLE Khach_Hang CASCADE CONSTRAINTS;" },
        { Id: 103489, Text: "DROP TABLE Khach_Hang IGNORE CONSTRAINTS;" },
        { Id: 103490, Text: "ERASE TABLE Khach_Hang CASCADE CONSTRAINTS;" },
      ],
    },
    {
      Id: 24953,
    ...
    },
    {
      ...
      Answers: [
        ...
        { Id: 103498, Text: "ALTER TABLE Khach_Hang UNIQUE (MaKH);" },
      ],
    },
    {
      Id: 24955,
      ...
      AnswerId: 103502,
      Answers: [
        { Id: 103499, Text: "REPAIR TABLE …" },
        { Id: 103500, Text: "CHANGE TABLE …" },
        { Id: 103501, Text: "REDO TABLE …" },
        { Id: 103502, Text: "ALTER TABLE …" },
      ],
    },
  ];
});
