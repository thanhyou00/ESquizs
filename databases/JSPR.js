  ...
  $scope.src = [
    {
      ...
      AnswerId: 106533,
      Answers: [
        { Id: 106530, Text: "Khi dịch vụ chưa sẵn sàng để truy nhập dữ liệu" },
        { Id: 106531, Text: "Đưa ra một thông điệp cảnh báo đến người dùng" },
        { Id: 106532, Text: "Kết quả sau khi tính toán không hợp lệ" },
        { Id: 106533, Text: "Tất cả các trường hợp đã nêu" },
      ],
    },
    {
      Id: 25741,
    ...
    },
    {
      ...
      AnswerId: 106540,
      Answers: [
        { Id: 106540, Text: "\u003cscript\u003e\u003c/script\u003e" },
        { Id: 106541, Text: "\u003cscripting\u003e/\u003cscripting\u003e" },
        { Id: 106542, Text: "\u003cjs\u003e\u003c/js\u003e" },
        { Id: 106543, Text: "\u003cJavaScript\u003e\u003c/JavaScript\u003e" },
      ],
    },
    {
      Id: 25744,
      ...
      AnswerId: 106546,
      Answers: [
        { Id: 106544, Text: "Xử lý file của người dùng" },
        { Id: 106545, Text: "Hỗ trợ mạng" },
        { Id: 106546, Text: "Điều khiển trình duyệt" },
      ],
    },
    {
      Id: 25745,
      ...
      AnswerId: 106547,
      Answers: [
        { Id: 106547, Text: "Netscape" },
        { Id: 106548, Text: "NEC" },
        { Id: 106549, Text: "Microsoft" },
        {
          Id: 106550,
    ...
    },
    {
      ...
      AnswerId: 106553,
      Answers: [
        { Id: 106551, Text: "Các phương án đều sai" },
        { Id: 106552, Text: "Khi người dùng nhấn vào menu" },
        { Id: 106553, Text: "Các phương án đều đúng" },
        { Id: 106554, Text: "Khi người dùng nhấn chuột" },
      ],
    },
    {
      Id: 25747,
    ...
    },
    {
      ...
      AnswerId: 106561,
      Answers: [
        { Id: 106559, Text: "dấu chấm (.)" },
        { Id: 106560, Text: "dấu hai chấm (:)" },
        { Id: 106561, Text: "dấu cách (space)" },
        { Id: 106562, Text: "dấu gạch dưới (_)" },
      ],
    },
    {
      Id: 25749,
    ...
    },
    {
      ...
      AnswerId: 106572,
      Answers: [
        { Id: 106571, Text: "Không trả về giá trị nào cả" },
        { Id: 106572, Text: "TRUE" },
        { Id: 106573, Text: "FALSE" },
        { Id: 106574, Text: "Đưa ra thông báo lỗi cú pháp" },
      ],
    },
    {
      Id: 25752,
      ...
      AnswerId: 106576,
      Answers: [
        { Id: 106575, Text: "if (i \u003c\u003e 5) {}" },
        { Id: 106576, Text: "if (i != 5) {}" },
        { Id: 106577, Text: "if i\u003c\u003e5 {}" },
        { Id: 106578, Text: "if i=! 5 then {}" },
      ],
    },
    {
      Id: 25753,
      ...
      Answers: [
        { Id: 106579, Text: "Null" },
        { Id: 106580, Text: "Break" },
        { Id: 106581, Text: "Indefined" },
        { Id: 106582, Text: "Infinity" },
      ],
    },
    {
      Id: 25754,
      ...
      AnswerId: 106586,
      Answers: [
        { Id: 106583, Text: "Math.rnd(7.25)" },
        { Id: 106584, Text: "round(7.25)" },
        { Id: 106585, Text: "rnd(7.25)" },
        { Id: 106586, Text: "Math.round(7.25)" },
      ],
    },
    {
      Id: 25755,
      ...
      Answers: [
        ...
        { Id: 106590, Text: "Các phương án đều sai" },
      ],
    },
    {
      Id: 25756,
    ...
    },
    {
      ...
      AnswerId: 106598,
      Answers: [
        { Id: 106595, Text: "const giáTrị = tênHằng;" },
        { Id: 106596, Text: "const giáTrị == tênHằng;" },
        { Id: 106597, Text: "const tênHằng == giáTrị;" },
        { Id: 106598, Text: "Trong JavaScript không có kiểu hằng số const" },
      ],
    },
    {
      Id: 25758,
      ...
      AnswerId: 106600,
      Answers: [
        { Id: 106599, Text: "function:myFunction()" },
        { Id: 106600, Text: "function myFunction()" },
        { Id: 106601, Text: "function=myFunction()" },
      ],
    },
    {
      Id: 25759,
    ...
    },
    {
      ...
      AnswerId: 106609,
      Answers: [
        { Id: 106606, Text: "Khi click chuột" },
        { Id: 106607, Text: "Khi di chuyển chuột qua." },
        { Id: 106608, Text: "Khi kết thúc một chương trình" },
        { Id: 106609, Text: "Khi bắt đầu chương trình chạy" },
      ],
    },
    {
      Id: 25761,
      ...
      AnswerId: 106613,
      Answers: [
        { Id: 106610, Text: "Khi một đối tượng trong form mất focus." },
        { Id: 106611, Text: "Khi một đối tượng trong form có focus" },
        { Id: 106612, Text: "Khi click chuột vào nút lệnh" },
        {
          Id: 106613,
    ...
    },
    {
      ...
      AnswerId: 106615,
      Answers: [
        { Id: 106614, Text: "Không thể kết hợp được." },
        { Id: 106615, Text: "Thoát khỏi vòng lặp" },
        { Id: 106616, Text: "Nhảy đến một tập lệnh khác" },
        { Id: 106617, Text: "Không có ý nghĩa trong vòng lặp" },
      ],
    },
    {
      Id: 25763,
      ...
      AnswerId: 106619,
      Answers: [
        { Id: 106618, Text: "Khi kết thúc thì một site khác hiện ra" },
        { Id: 106619, Text: "Khi chạy thì một trang khác (VNN) được hiện ra" },
        { Id: 106620, Text: "Hiện một trang vnn duy nhất" },
        { Id: 106621, Text: "Không chạy được vì sai" },
      ],
    },
    {
      Id: 25764,
      ...
      AnswerId: 106625,
      Answers: [
        { Id: 106622, Text: "Không thuộc dạng nào đã nêu" },
        { Id: 106623, Text: "Cả hai dạng đã nêu" },
        { Id: 106624, Text: "Không xác định và xét điều kiện rồi mới lặp" },
        { Id: 106625, Text: "Không xác định và lặp rồi mới xét điều kiện" },
      ],
    },
    {
      Id: 25765,
      ...
      AnswerId: 106627,
      Answers: [
        { Id: 106626, Text: "while i=1 to 10 {}" },
        { Id: 106627, Text: "while (i\u003c=10) {}" },
        { Id: 106628, Text: "white (i=0;i++;i=10) {}" },
        { Id: 106629, Text: "while (i\u003c=10;i++) {}" },
      ],
    },
    {
      Id: 25766,
      ...
      Answers: [
        ...
        { Id: 106632, Text: "Hàm là một khối lệnh và được gán bởi một tên." },
        { Id: 106633, Text: "Các phương án đều đúng" },
      ],
    },
    {
      Id: 25767,
      ...
      Answers: [
        ...
        { Id: 106635, Text: "Tất cả các dạng đã nêu." },
        {
          Id: 106636,
    ...
    },
    {
      ...
      AnswerId: 106640,
      Answers: [
        { Id: 106638, Text: "Không thuộc dạng nào đã nêu" },
        { Id: 106639, Text: "Không xác định và lặp rồi mới xét điều kiện" },
        { Id: 106640, Text: "Không xác định và xét điều kiện rồi mới lặp" },
        { Id: 106641, Text: "Cả hai dạng đã nêu" },
      ],
    },
    {
      Id: 25769,
      ...
      AnswerId: 106644,
      Answers: [
        { Id: 106642, Text: "Khi một đối tượng trong form có focus" },
        { Id: 106643, Text: "Khi một đối tượng trong form mất focus." },
        {
          Id: 106644,
          Text: "Khi di chuyển con chuột qua một đối tượng trong form.",
        },
        { Id: 106645, Text: "Khi click chuột vào nút lệnh" },
      ],
    },
    {
      Id: 25770,
      ...
      Answers: [
        ...
        { Id: 106649, Text: "Tất cả đều đúng" },
      ],
    },
    {
      Id: 25771,
      ...
      AnswerId: 106650,
      Answers: [
        { Id: 106650, Text: "Đối tượng mà sự kiện diễn ra trong đó" },
        {
          Id: 106651,
          Text: "Tọa độ của cửa số trang tại vị trí xảy ra sự kiện",
        },
        { Id: 106652, Text: "Trả về đối tượng đầu tiên mà sự kiện diễn ra" },
        { Id: 106653, Text: "Loại sự kiện" },
      ],
    },
    {
      Id: 25772,
      ...
      AnswerId: 106656,
      Answers: [
        { Id: 106654, Text: "screen" },
        { Id: 106655, Text: "navigator" },
        { Id: 106656, Text: "location" },
        { Id: 106657, Text: "window" },
      ],
    },
    {
      Id: 25773,
      ...
      AnswerId: 106661,
      Answers: [
        { Id: 106658, Text: "Frames" },
        { Id: 106659, Text: "History" },
        { Id: 106660, Text: "Location" },
        { Id: 106661, Text: "Document" },
      ],
    },
    {
      Id: 25774,
      ...
      AnswerId: 106665,
      Answers: [
        { Id: 106662, Text: "Text area" },
        { Id: 106663, Text: "Document" },
        { Id: 106664, Text: "Button" },
        { Id: 106665, Text: "Image" },
      ],
    },
    {
      Id: 25775,
      ...
      AnswerId: 106666,
      Answers: [
        { Id: 106666, Text: "history" },
        { Id: 106667, Text: "opener" },
        { Id: 106668, Text: "pageYOffset" },
        { Id: 106669, Text: "back" },
      ],
    },
    {
      ...
      AnswerId: 106670,
      Answers: [
        { Id: 106670, Text: "setTimeout(câu lệnh JavaScript, số milli giây)" },
        { Id: 106671, Text: "setTimeOut()" },
        { Id: 106672, Text: "clearTimeout(số milli giây)" },
        { Id: 106673, Text: "setInterval(câu lệnh JavaScript, số milli giây)" },
      ],
    },
    {
      Id: 25777,
      ...
      AnswerId: 106674,
      Answers: [
        { Id: 106674, Text: "Object Oriented Programming" },
        { Id: 106675, Text: "Object Operating Programming" },
        { Id: 106676, Text: "Object Occult Programming" },
        { Id: 106677, Text: "Object Overloading Programming" },
      ],
    },
    {
      Id: 25778,
    ...
    },
    {
      ...
      AnswerId: 106686,
      Answers: [
        { Id: 106686, Text: "margin-left:" },
        { Id: 106687, Text: "indent:" },
        { Id: 106688, Text: "margin:" },
        { Id: 106689, Text: "text-indent:" },
      ],
    },
    {
      Id: 25781,
      ...
      AnswerId: 106693,
      Answers: [
        { Id: 106690, Text: "You can’t do that with CSS" },
        { Id: 106691, Text: "text-style:capitalize" },
        { Id: 106692, Text: "text-transform:uppercase" },
        { Id: 106693, Text: "text-transform:capitalize" },
      ],
    },
    {
      Id: 25782,
      ...
      AnswerId: 106696,
      Answers: [
        { Id: 106694, Text: "encodeURI();" },
        { Id: 106695, Text: "focus();" },
        { Id: 106696, Text: "decodeURI();" },
        { Id: 106697, Text: "restore();" },
      ],
    },
    {
      Id: 25783,
      ...
      AnswerId: 106701,
      Answers: [
        { Id: 106698, Text: "Màu của liên kết" },
        { Id: 106699, Text: "Màu nền của trang web" },
        { Id: 106700, Text: "Màu của liên kết khi trỏ đến" },
        { Id: 106701, Text: "Màu của liên kết đã kích hoạt" },
      ],
    },
    {
      Id: 25784,
      ...
      Answers: [
        ...
        { Id: 106703, Text: "Hiển thị các thuộc tính của đối tượng navigator" },
        {
          Id: 106704,
    ...
    },
    {
      ...
      AnswerId: 106706,
      Answers: [
        { Id: 106706, Text: "Tên mã của trình duyệt" },
        { Id: 106707, Text: "Hệ điều hành của trình duyệt" },
        { Id: 106708, Text: "Tên của trình duyệt" },
        { Id: 106709, Text: "Phiên bản của trình duyệt" },
      ],
    },
    {
      Id: 25786,
      ...
      AnswerId: 106711,
      Answers: [
        { Id: 106710, Text: "onKeyUp();" },
        { Id: 106711, Text: "onLoad();" },
        { Id: 106712, Text: "onKeyPress();" },
        { Id: 106713, Text: "onScroll();" },
      ],
    },
    {
      Id: 25787,
      ...
      AnswerId: 106716,
      Answers: [
        { Id: 106714, Text: "\u003cstyle src=”mystyle.css”\u003e" },
        {
          Id: 106715,
        ...
        { Id: 106717, Text: "Các phương án đều sai" },
      ],
    },
    {
      Id: 25788,
      ...
      AnswerId: 106721,
      Answers: [
        { Id: 106718, Text: "a {underline:none}" },
        { Id: 106719, Text: "a {decoration:no underline}" },
        { Id: 106720, Text: "a {text-decoration:no underline}" },
        { Id: 106721, Text: "a {text-decoration:none}" },
      ],
    },
    {
      Id: 25789,
      ...
      AnswerId: 106723,
      Answers: [
        { Id: 106722, Text: "{text-size:bold}" },
        { Id: 106723, Text: "p {font-weight:bold}" },
        { Id: 106724, Text: "\u003cp style=”text-size:bold”\u003e" },
        { Id: 106725, Text: "\u003cp style=”font-size:bold”\u003e" },
      ],
    },
    {
      Id: 25790,
      ...
      AnswerId: 106727,
      Answers: [
        { Id: 106726, Text: "\u003cselect\u003e…\u003c/select\u003e" },
        { Id: 106727, Text: "\u003cinput\u003e…\u003c/input\u003e" },
        { Id: 106728, Text: "\u003cspan\u003e..\u003c/span\u003e" },
        { Id: 106729, Text: "\u003cinsert\u003e…\u003c/insert\u003e" },
      ],
    },
    {
      Id: 25791,
      ...
      Answers: [
        ...
        { Id: 106731, Text: "Thiết lập frame để submit dữ liệu đến" },
        { Id: 106732, Text: "Thiết lập/Trả về các action trên form" },
        { Id: 106733, Text: "Thiết lập frame để submit dữ liệu đến" },
      ],
    },
    {
      Id: 25792,
      ...
      AnswerId: 106734,
      Answers: [
        { Id: 106734, Text: "Tạo một nút lệnh dùng để gửi tin trong form đi" },
        { Id: 106735, Text: "Tạo một cùng có nhiều cột nhiều dòng" },
        { Id: 106736, Text: "Tất cả các ý đã nêu" },
        { Id: 106737, Text: "Tạo một ô text để nhập dữ liệu" },
      ],
    },
    {
      Id: 25793,
      ...
      AnswerId: 106739,
      Answers: [
        { Id: 106738, Text: "Gửi dữ liệu trong form" },
        {
          Id: 106739,
          Text: "Thiết lập lại các giá trị của các trường dữ liệu của form",
        },
        { Id: 106740, Text: "Thiết lập frame để submit dữ liệu đến" },
        { Id: 106741, Text: "Trả về phương thức HTTP để submit một form" },
      ],
    },
    {
      Id: 25794,
      ...
      Answers: [
        ...
        { Id: 106743, Text: "Tất cả các ý đã nâu" },
        { Id: 106744, Text: "Tạo một ô text để nhập dữ liệu" },
        { Id: 106745, Text: "Tạo một cùng có nhiều cột nhiều dòng" },
      ],
    },
    {
      Id: 25795,
      ...
      AnswerId: 106746,
      Answers: [
        { Id: 106746, Text: "Khi gửi dữ liệu" },
        { Id: 106747, Text: "Khi sao chép dữ liệu" },
        { Id: 106748, Text: "Khi xóa dữ liệu" },
        { Id: 106749, Text: "Khi nhập dữ liệu" },
      ],
    },
    {
      Id: 25796,
      ...
      AnswerId: 106750,
      Answers: [
        { Id: 106750, Text: "TextArea" },
        { Id: 106751, Text: "Password" },
        { Id: 106752, Text: "Text" },
        { Id: 106753, Text: "SelectBox" },
      ],
    },
    {
      Id: 25797,
      ...
      AnswerId: 106754,
      Answers: [
        { Id: 106754, Text: "Tạo một vùng nhập văn bản nhiều cột nhiều dòng" },
        { Id: 106755, Text: "Tạo một ô text để nhập dữ liệu" },
        { Id: 106756, Text: "Tất cả các phương án đều đúng" },
        { Id: 106757, Text: "Tạo một ô password" },
      ],
    },
    {
      Id: 25798,
      ...
      AnswerId: 106760,
      Answers: [
        { Id: 106758, Text: "document.forms.options[i];" },
        { Id: 106759, Text: "document.forms.name_select.options[i];" },
        {
          Id: 106760,
          Text: "document.forms.name_form.name_select.options[i];",
        },
        { Id: 106761, Text: "document.name_form.name_select.options[i];" },
      ],
    },
    {
      Id: 25799,
      ...
      Answers: [
        { Id: 106762, Text: "Type" },
        { Id: 106763, Text: "Name" },
        { Id: 106764, Text: "Target" },
        { Id: 106765, Text: "Method" },
      ],
    },
    {
      Id: 25800,
    ...
    },
    {
      ...
      AnswerId: 106774,
      Answers: [
        { Id: 106774, Text: ".fadeOut()" },
        { Id: 106775, Text: ".hide()" },
        { Id: 106776, Text: ".fadeTo()" },
        { Id: 106777, Text: ".fadeOff()" },
      ],
    },
    {
      Id: 25803,
      ...
      AnswerId: 106778,
      Answers: [
        { Id: 106778, Text: "$(“a[href^=’#’]”)" },
        { Id: 106779, Text: "$(“a[href$=’#’]”)" },
        { Id: 106780, Text: "$(“a[href!=’#’]”)" },
        { Id: 106781, Text: "$(“a[href*=’#’]”)" },
      ],
    },
    {
      Id: 25804,
      ...
      AnswerId: 106785,
      Answers: [
        { Id: 106782, Text: "Draggable()" },
        { Id: 106783, Text: "Dapicker()" },
        { Id: 106784, Text: "Droppable()" },
        { Id: 106785, Text: "Accordion()" },
      ],
    },
    {
      Id: 25805,
      ...
      AnswerId: 106788,
      Answers: [
        { Id: 106786, Text: "$(bind).selector(event, data, handler)" },
        { Id: 106787, Text: "$(bind).selector(data, handler, event)" },
        { Id: 106788, Text: "$(selector).bind(event, data, handler)" },
        { Id: 106789, Text: "$(selector).bind(data, handler, event)" },
      ],
    },
    {
      Id: 25806,
      ...
      Answers: [
        ...
        { Id: 106791, Text: "Chỉ ra việc sử dụng thư viện jQuery" },
        { Id: 106792, Text: "Chỉ ra các phần tử được chọn" },
        { Id: 106793, Text: "Chỉ ra thư mục chứa thư viện jQuery" },
      ],
    },
    {
      Id: 25807,
      ...
      AnswerId: 106795,
      Answers: [
        { Id: 106794, Text: "Thực thi khi ta kéo trượt thanh trượt" },
        { Id: 106795, Text: "Xử lý tất cả các sự kiện hiện hành" },
        { Id: 106796, Text: "Load một sự kiện JavaScript" },
        { Id: 106797, Text: "Bắt sự kiện click" },
      ],
    },
    {
      Id: 25808,
      ...
      AnswerId: 106801,
      Answers: [
        { Id: 106798, Text: "$(\u0027a#linkID\u0027)" },
        { Id: 106799, Text: "$(\u0027a?linkID\u0027)" },
        { Id: 106800, Text: '$("a?linkID")' },
        { Id: 106801, Text: '$("a#linkID")' },
      ],
    },
    {
      Id: 25809,
      ...
      AnswerId: 106803,
      Answers: [
        { Id: 106802, Text: "$(“a[href^=’#’]”)" },
        { Id: 106803, Text: "$(“a[href$=’#’]”)" },
        { Id: 106804, Text: "$(“a[href!=’#’]”)" },
        { Id: 106805, Text: "$(“a[href*=’#’]”)" },
      ],
    },
    {
      Id: 25810,
      ...
      AnswerId: 106806,
      Answers: [
        { Id: 106806, Text: "Google" },
        { Id: 106807, Text: "Yahoo" },
        { Id: 106808, Text: "Facebook" },
        { Id: 106809, Text: "IBM" },
      ],
    },
    {
    ...
    },
    {
      ...
      AnswerId: 106814,
      Answers: [
        { Id: 106814, Text: "Chuyển đổi C++ thành asm.js" },
        { Id: 106815, Text: "Chuyển đổi JavaScript thành asm.js" },
        { Id: 106816, Text: "Chuyển đổi PHP thành asm.js" },
        { Id: 106817, Text: "Chuyển đổi C# thành asm.js" },
      ],
    },
    {
      Id: 25813,
      ...
      AnswerId: 106821,
      Answers: [
        { Id: 106818, Text: "được cập nhật ngay sau active" },
        { Id: 106819, Text: "được cập nhật ngay sau khi reload trang" },
        { Id: 106820, Text: "được cập nhật ngay sau hover" },
        { Id: 106821, Text: "được cập nhật ngay mà không cần reload" },
      ],
    },
    {
      Id: 25814,
      ...
      Answers: [
        { Id: 106822, Text: "Body" },
        { Id: 106823, Text: "Head" },
        { Id: 106824, Text: "Meta Description" },
        { Id: 106825, Text: "Title" },
      ],
    },
    {
      Id: 25815,
      ...
      AnswerId: 106828,
      Answers: [
        { Id: 106826, Text: "\u0027footer" },
        { Id: 106827, Text: "Content" },
        { Id: 106828, Text: "Head" },
        { Id: 106829, Text: "Body" },
      ],
    },
    {
      ...
      AnswerId: 106830,
      Answers: [
        { Id: 106830, Text: "Phân biệt thành phần do AngularJS tạo ra" },
        { Id: 106831, Text: "Khai báo PHP trong javascript" },
        { Id: 106832, Text: "Là điểm kết thúc của AngularJS" },
        { Id: 106833, Text: "Là điểm bắt đầu của AngularJS" },
      ],
    },
    {
      Id: 25817,
      ...
      AnswerId: 106836,
      Answers: [
        { Id: 106834, Text: "myDataRef.write(\u0027dữ liệu\u0027);" },
        { Id: 106835, Text: "myDataRef.writeln(\u0027dữ liệu\u0027);" },
        { Id: 106836, Text: "myDataRef.set(\u0027dữ liệu\u0027);" },
        { Id: 106837, Text: "myDataRef.get(\u0027dữ liệu\u0027);" },
      ],
    },
    {
      Id: 25818,
      ...
      AnswerId: 106838,
      Answers: [
        { Id: 106838, Text: "Hỗ trợ Hướng đối tượng" },
        { Id: 106839, Text: "Hỗ trợ Hướng dịch vụ" },
        { Id: 106840, Text: "Tất cả các phương án đều sai" },
        { Id: 106841, Text: "Không hỗ trợ JavaScript" },
      ],
    },
    {
      Id: 25819,
      ...
      AnswerId: 106845,
      Answers: [
        { Id: 106842, Text: "Phát triển giao diện" },
        { Id: 106843, Text: "Phát triển ứng dụng PHP" },
        { Id: 106844, Text: "Phát triển ứng dụng server" },
        { Id: 106845, Text: "Phát triển ứng dụng MVC" },
      ],
    },
  ];
});
